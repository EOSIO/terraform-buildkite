		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("buildkite_pipeline.test_github", "github_settings.0.build_pull_requests", "true"), // buildkite api returns true as a default for some of these
					resource.TestCheckResourceAttr("buildkite_pipeline.test_github", "github_settings.0.build_tags", "false"),
					resource.TestCheckResourceAttr("buildkite_pipeline.test_github", "github_settings.0.prefix_pull_request_fork_branch_names", "true"), // buildkite api returns true as a default for some of these
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("buildkite_pipeline.test_bitbucket", "bitbucket_settings.0.publish_commit_status", "true"), // buildkite api returns true as a default for some of these
